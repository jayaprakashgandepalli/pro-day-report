  ...
  const categories = [
    ...
    },
    {
      ...
      details: {
        ...
        ugJobs: ['పోలీస్ (కానిస్టేబుల్, ఎస్ఐ)', 'గ్రూప్స్ (Group-2, 4) ఉద్యోగాలు', 'ల్యాబ్ అసిస్టెంట్'],
  ...
  const categories = [
    ...
    },
    {
      ...
      details: {
        ...
        ugJobs: ['(ట్రైనింగ్ పూర్తి కాగానే) డిఫెన్స్ ఆఫీసర్', 'పైలట్', 'నేవీ ఆఫీసర్ (దేశ సేవ)'],
  ...
  const categories = [
    ...
    },
    {
      ...
      details: {
        ...
        ugJobs: ['హాస్పిటల్స్ లో హెల్త్ అసిస్టెంట్', 'ల్యాబ్ టెక్నీషియన్ (బ్లడ్ టెస్టింగ్)'],
